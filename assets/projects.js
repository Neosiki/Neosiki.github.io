const portfolioProjects = [
  ...
  { title: '네오디자인스튜디오 제작 운영 시스템', category: 'automation', categoryLabel: 'AI·AX·자동화', description: '제작 작업의 진행 상태와 실패 원인을 한 화면에서 확인합니다. 필요한 부분만 다시 처리하고 검수 이력까지 남겨 콘텐츠 제작팀의 운영 부담을 줄입니다.', language: 'JOBS · CACHE · QA', featured: true, url: 'https://github.com/Neosiki/design-studio' , image: 'archive-09-design-studio.png'},
